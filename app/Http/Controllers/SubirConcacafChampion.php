...
use App\Models\World\ConcacafChampion;
use App\Models\World\ConcacafChampionStat;
use App\Models\Log;
...
class SubirConcacafChampion extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!ConcacafChampion::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !ConcacafChampionStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!ConcacafChampion::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                        
                            $fixtures = ConcacafChampion::create([
                        ...
                        if (!ConcacafChampionStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
