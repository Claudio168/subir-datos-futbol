...
use App\Models\Alemania\DFB_Pokal2023;
use App\Models\Alemania\DFB_Pokal_Stat2023;
use App\Models\Log;
...
class SubirDFB_Pokal extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!DFB_Pokal2023::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !DFB_Pokal_Stat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!DFB_Pokal2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                        
                            $fixtures = DFB_Pokal2023::create([
                        ...
                        /*
                        if (!DFB_Pokal_Stat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
