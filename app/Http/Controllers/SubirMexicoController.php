...
use App\Models\Mexico\LigaMX2023;
use App\Models\Mexico\LigaMXStat2023;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirMexicoController extends Controller
{
            ...
            if ($data['response'] == []) {
             ...
             if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!LigaMX2023::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !LigaMXStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!LigaMX2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = LigaMX2023::create([
                        ...
                        if (!LigaMXStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
