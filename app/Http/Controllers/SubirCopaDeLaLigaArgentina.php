...
use App\Models\Argentina\CopaDeLaLiga;
use App\Models\Argentina\CopaDeLaLigaStat;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirCopaDeLaLigaArgentina extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!CopaDeLaLiga::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !CopaDeLaLigaStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!CopaDeLaLiga::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = CopaDeLaLiga::create([
                        ...
                        /*
                        if (!CopaDeLaLigaStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
