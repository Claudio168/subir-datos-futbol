...
use App\Models\Brasil\Brasileirao2024;
use App\Models\Brasil\BrasileiraoStat2024;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirBrasilController extends Controller
{
            ...
            if ($data['response'] == []) {
             ...
             if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!Brasileirao2024::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !BrasileiraoStat2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!Brasileirao2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = Brasileirao2024::create([
                        ...
                        if (!BrasileiraoStat2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
