...
use App\Models\World\CopaSudamericana2024;
use App\Models\World\CopaSudamericanaStat2024;
use App\Models\Log;
...
class SubirCopaSudamericana2024 extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!CopaSudamericana2024::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !CopaSudamericanaStat2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!CopaSudamericana2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                        
                            $fixtures = CopaSudamericana2024::create([
                        ...
                        if (!CopaSudamericanaStat2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            ...
                            if ($response2->ok()) {
                                ...
                                if (isset($data2['response']) && is_array($data2['response'])) {
                                    ...
                                    foreach ($data2['response'] as $indice => $fixtureData2) {
                                        if (!CopaSudamericanaStat2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                                            $contadorStats++;
                                            CopaSudamericanaStat2024::create([
                                                'fixture_date' => $fechaFormateada,
                                                'fixture_id' => $fixtureData['fixture']['id'],
                                                'fixture_referee' =>  $fixtureData['fixture']['referee'],
                                                'fixture_timestamp' => $fechaHora,
