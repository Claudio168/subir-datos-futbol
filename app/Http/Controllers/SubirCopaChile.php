...
use App\Models\Chile\CopaChile;
use App\Models\Chile\CopaChileStat;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirCopaChile extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!CopaChile::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !CopaChileStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!CopaChile::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = CopaChile::create([
                       ...
                       /*
                        if (!CopaChileStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
