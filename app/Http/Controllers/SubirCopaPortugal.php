...
use App\Models\Portugal\CopaPortugal;
use App\Models\Portugal\CopaPortugalStat;
use App\Models\Log;
...
class SubirCopaPortugal extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!CopaPortugal::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !CopaPortugalStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!CopaPortugal::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;

                            $fixtures = CopaPortugal::create([
                        ...
                        /*
                        if (!CopaPortugalStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
