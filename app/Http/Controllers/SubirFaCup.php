...
use App\Models\Inglaterra\FaCupFixture2023;
use App\Models\Inglaterra\FaCupStat2023;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirFaCup extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!FaCupFixture2023::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !FaCupStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!FaCupFixture2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = FaCupFixture2023::create([
                        ...
                        /*
                        if (!FaCupStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
