...
use App\Models\World\CopaLibertadores2024;
use App\Models\World\CopaLibertadoresStat2024;
use App\Models\Log;
...
class SubirCopaLibertadores2024 extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!CopaLibertadores2024::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !CopaLibertadoresStat2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!CopaLibertadores2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                        
                            $fixtures = CopaLibertadores2024::create([
                        ...
                        if (!CopaLibertadoresStat2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            ...
                            if ($response2->ok()) {
                                ...
                                if (isset($data2['response']) && is_array($data2['response'])) {
                                    ...
                                    foreach ($data2['response'] as $indice => $fixtureData2) {
                                        if (!CopaLibertadoresStat2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                                            $contadorStats++;
                                            CopaLibertadoresStat2024::create([
                                                'fixture_date' => $fechaFormateada,
                                                'fixture_id' => $fixtureData['fixture']['id'],
                                                'fixture_referee' =>  $fixtureData['fixture']['referee'],
                                                'fixture_timestamp' => $fechaHora,
