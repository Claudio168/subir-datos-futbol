...
use App\Models\Francia\CopaFrancia;
use App\Models\Francia\CopaFranciaStat;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirCopaFrancia extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!CopaFrancia::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !CopaFranciaStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!CopaFrancia::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = CopaFrancia::create([
                       ...
                       /*
                        if (!CopaFranciaStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
