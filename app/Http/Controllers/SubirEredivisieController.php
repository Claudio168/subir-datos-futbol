...
use App\Models\PaisesBajos\Eredivisie2023;
use App\Models\PaisesBajos\EredivisieStat2023;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirEredivisieController extends Controller
{
        ...
        if ($response->ok()) {
           ...
           if (isset($data['response']) && is_array($data['response'])) {
            ...
            foreach ($data['response'] as $fixtureData) {
                ...
                if (!Eredivisie2023::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !EredivisieStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                    ...
                    if (!Eredivisie2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        $contadorPartidos++;
                        //se rellena la tabla premierleaguefixture
                        $fixtures = Eredivisie2023::create([
                    ...
                    if (!EredivisieStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
