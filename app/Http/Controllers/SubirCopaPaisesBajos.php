...
use App\Models\PaisesBajos\CopaPaisesBajos;
use App\Models\PaisesBajos\CopaPaisesBajosStat;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirCopaPaisesBajos extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!CopaPaisesBajos::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !CopaPaisesBajosStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!CopaPaisesBajos::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = CopaPaisesBajos::create([
                        ...
                        /*
                        if (!CopaPaisesBajosStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
