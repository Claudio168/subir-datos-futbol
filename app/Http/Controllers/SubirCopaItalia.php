...
use App\Models\Italia\CopaItalia2023;
...
class SubirCopaItalia extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!CopaItalia2023::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !FixtureElCalcioStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!CopaItalia2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;

                            $fixtures = CopaItalia2023::create([
