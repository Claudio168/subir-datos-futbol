...
use App\Models\Inglaterra\PremierLeagueFixture2023;
use App\Models\Inglaterra\PremierLeagueStat2023;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class Subirpremierleaguefixtures extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!PremierLeagueFixture2023::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !PremierLeagueStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!PremierLeagueFixture2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = PremierLeagueFixture2023::create([
                        ...
                        if (!PremierLeagueStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
