...
use App\Models\Argentina\SuperLiga2024;
use App\Models\Argentina\SuperLigaStats2024;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirArgentinaController extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!SuperLiga2024::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !SuperLigaStats2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!SuperLiga2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = SuperLiga2024::create([
                        ...
                        if (!SuperLigaStats2024::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
