...
use App\Models\World\EuropaLeague2023;
use App\Models\World\EuropaLeagueStat2023;
use App\Models\Log;
...
class SubirEuropaLeague extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!EuropaLeague2023::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !EuropaLeagueStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!EuropaLeague2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                        
                            $fixtures = EuropaLeague2023::create([
                        ...
                        if (!EuropaLeagueStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
