...
use App\Models\Colombia\CopaColombia;
use App\Models\Colombia\CopaColombiaStat;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirCopaColombia extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!CopaColombia::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !CopaColombiaStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!CopaColombia::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = CopaColombia::create([
                       ...
                       /*
                        if (!CopaColombiaStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
