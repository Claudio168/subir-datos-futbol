...
use App\Models\Portugal\Primeira_liga2023;
use App\Models\Portugal\PrimeiraLigaStat2023;
use Illuminate\Support\Facades\Http;
use App\Models\Log;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirPrimeiraLigaFixture extends Controller
{
            ...
            if ($data['response'] == []) {
              ...
              if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!Primeira_liga2023::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !PrimeiraLigaStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!Primeira_liga2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = Primeira_liga2023::create([
                        ...
                        if (!PrimeiraLigaStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
