...
use App\Models\World\ChampionLeague2023;
use App\Models\World\ChampionLeagueStat2023;
use App\Models\Log;
...
class SubirChampionLeague extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!ChampionLeague2023::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !ChampionLeagueStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!ChampionLeague2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                        
                            $fixtures = ChampionLeague2023::create([
                        ...
                        if (!ChampionLeagueStat2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
