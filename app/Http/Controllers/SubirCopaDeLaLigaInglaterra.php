...
use App\Models\Inglaterra\CopaLiga;
use App\Models\Inglaterra\CopaLigaStat;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirCopaDeLaLigaInglaterra extends Controller
{
        ...
        if ($response->ok()) {
            ...
            if (isset($data['response']) && is_array($data['response'])) {
                ...
                foreach ($data['response'] as $fixtureData) {
                    ...
                    if (!CopaLiga::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !CopaLigaStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        ...
                        if (!CopaLiga::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                            $contadorPartidos++;
                            //se rellena la tabla premierleaguefixture
                            $fixtures = CopaLiga::create([
                        ...
                        /*
                        if (!CopaLigaStat::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
