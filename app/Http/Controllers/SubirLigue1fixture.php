...
use App\Models\Francia\Ligue1_2023;
use App\Models\Francia\Ligue1Stats;
use App\Models\Log;
use Illuminate\Support\Facades\Http;
use Carbon\Carbon;
use Twilio\Rest\Client;

class SubirLigue1fixture extends Controller
{
        ...
        if ($response->ok()) {
           ...
           if (isset($data['response']) && is_array($data['response'])) {
            ...
            foreach ($data['response'] as $fixtureData) {
                ...
                if (!Ligue1_2023::where('fixture_id', $fixtureData['fixture']['id'])->exists() || !Ligue1Stats::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                    ...
                    if (!Ligue1_2023::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
                        $contadorPartidos++;
                        //se rellena la tabla premierleaguefixture
                        $fixtures = Ligue1_2023::create([
                    ...
                    if (!Ligue1Stats::where('fixture_id', $fixtureData['fixture']['id'])->exists()) {
